...
Embed a sales overview dashboard in my React app. My Metabase is at http://localhost:13000. I'm using API key auth and my key is already in `NEXT_PUBLIC_METABASE_URL` / `METABASE_API_KEY`. The Sales Overview dashboard already exists in Metabase with ID 7.
